...
import { BookOpen, CheckCircle, TrendingUp, Target, Users, Globe, Laptop, GraduationCap } from 'lucide-react';
import { redirect } from 'next/navigation';
import Image from 'next/image';
import { PatientOrgTabs } from './tabs';

// Canonical module order for the GANSID Capacity Building Curriculum
const MODULE_ORDER: Record<string, number> = {
  '6b4906f1-803b-40bb-8582-d591220e5d09': 1,
  '823fe330-1df4-42ee-89af-d7df079958f5': 2,
  '9b228b9b-820f-4abb-92ac-d3a47091cab4': 3,
  '27692b1f-819f-4cfc-b2a0-2ae516c378e5': 4,
  '73ab4867-f29a-4bd3-b9bf-5f84705d9747': 5,
  '4d759125-3682-4698-83ae-8ba5a0e7630b': 6,
  '5f779fd0-2926-4bd7-a085-5959df2a5c74': 7,
  'd4657dcc-be32-489e-aed3-d8e4297a8a65': 8,
  '2b746569-abd1-4b5f-805a-8015055f6e67': 9,
  'f109c2ea-a204-42cf-9849-50676d3b9f44': 10,
};
...
export default async function PatientOrganizationsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      {/* Hero section */}
      <div className="bg-gradient-to-br from-[#1E3A5F] via-[#1E3A5F] to-[#0F172A] relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#0099CA] rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
          <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#DC2626] rounded-full blur-3xl translate-y-1/2 -translate-x-1/3" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-center gap-6">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur rounded-full px-3 py-1 mb-4">
                <Users className="h-3.5 w-3.5 text-[#0099CA]" />
                <span className="text-xs font-semibold text-white/80 uppercase tracking-wider">Patient Organizations</span>
              </div>
              <h1 className="text-3xl lg:text-4xl font-black text-white leading-tight mb-3">
                Patient Organizations&apos; Capacity Building Training Program
              </h1>
              <p className="text-slate-300 text-base max-w-2xl leading-relaxed">
                An 8-module e-course designed to equip patient advocacy organizations with the essential skills
                and knowledge needed to drive impactful change at local, national, and global levels.
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 className="text-2xl font-black text-[#0F172A] mb-6">Course Modules</h2>
      ...
      <div className="border-t border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-white border border-slate-100 rounded-2xl px-12 py-8 shadow-sm">
              <Image
                src="/vertex-logo.jpg"
