...
export function SlideTemplatePicker({ lessonId, onClose, onAddSlide }: SlideTemplatePickerProps) {
  ...
  // Portal to document.body so the modal escapes the editor shell's z-[40]
  // stacking context. Without this, the fixed overlay is trapped behind the
  // navbar (z-50) and clicks are intercepted.
  return createPortal(
